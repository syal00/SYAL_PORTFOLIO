...
const PROJECTS = [
  {
    ...
    desc: 'Designed and developed a scalable console-based banking system supporting account creation, deposits, withdrawals, and customer lookup. Applied object-oriented programming principles, exception handling, and optimized logic to ensure reliability and performance.',
    ss: '/portfolio.jpg',
  ...
  },
  {
    ...
    desc: 'Engineered a full-stack student registration portal using ASP.NET Core MVC and Entity Framework Core. Enabled secure course registration, real-time academic status viewing, and structured data management for enrollments and grades.',
    ss: '/portfolio.jpg',
  ...
  },
  {
    ...
    desc: 'Built a traffic light simulation using Python and CircuitPython, integrating NeoPixel LEDs with adjustable timing logic. Demonstrated automation, embedded systems, and hardware-software integration through both CLI and physical simulation.',
    ss: '/portfolio.jpg',
  ...
  },
  {
    ...
    desc: 'Created a task management application allowing users to create, update, prioritize, and track tasks. Implemented workflow controls to improve productivity and task organization.',
    ss: '/portfolio.jpg',
